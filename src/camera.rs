...
impl CameraState {
    ...
    pub fn update(&mut self) {
        ...
        if self.turning_left {
            ...
            self.direction.0 = x * self.angle.cos() + z * self.angle.sin();
            self.direction.2 = -1.0 * x * self.angle.sin() + z * self.angle.cos();
        }
    ...
    pub fn process_input(&mut self, event: &glium::winit::event::WindowEvent) {
        ...
        match &event.physical_key {
            ...
            PhysicalKey::Code(KeyCode::ArrowLeft) => self.turning_left = pressed,
            PhysicalKey::Code(KeyCode::ArrowRight) => self.turning_right = pressed,
